...
이러한 위임에 따라 Adobe에 의해 배치된 인프라에서는 위임되거나 CNAME 별칭이 지정된 각 전송 도메인에 대해 다음 서비스가 수행되도록 합니다.
...
>[!NOTE]
>
>[Campaign 컨트롤 패널](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html) 는 Adobe Managed Services를 사용하는 고객만 사용할 수 있습니다.
