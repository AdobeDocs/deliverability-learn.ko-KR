...
게시물 URL 예는 var headerUnsubUrl = &quot;http://campmomentumv7-mkt-prod3.campaign.adobe.com/webApp/unsubNoClick?id=&lt;%= recipient.cryptedId %>&quot;;을(를) 사용합니다. 다른 매개 변수( &amp;service = ...)를 추가할 수 있습니다.
