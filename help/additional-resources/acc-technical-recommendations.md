...
* 목록 구독 취소: mailto:unsubscribe@domain.com 구독 취소 링크를 클릭하면 사용자의 기본 이메일 클라이언트가 열립니다. 이 유형화 규칙은 이메일을 만드는 데 사용되는 유형화에 추가해야 합니다.

* 목록 구독 취소: https://domain.com/unsubscribe.jsp 구독 취소 링크를 클릭하면 사용자가 구독 취소 양식으로 리디렉션됩니다.
